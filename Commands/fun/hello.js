...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (member.id !== client.user.id) {
      embed
        .setDescription(`${interaction.member} says hello to ${member}`)
        .setImage(
          "https://i.pinimg.com/originals/f6/8c/b1/f68cb1daaf8c191fa1e5ddb065aef7bd.gif"
        );
    } else {
      embed
